namespace Topic_6b___Conditional_Loops
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int choices;
            Console.WriteLine("Who is the best ninja turtle?");
            do
            {
                Console.WriteLine("1 - Leonardo");
                Console.WriteLine("2 - Donatello");
                Console.WriteLine("3 - Raphael");
                Console.WriteLine("4 - Michelangelo");
                while (!Int32.TryParse(Console.ReadLine(), out choices))
                    Console.WriteLine("Invaild intput, enter an integer: ");
                if (choices != 4)
                {
            ...
            while (choices != 4);
            Console.WriteLine("Good chioce my freind.");
